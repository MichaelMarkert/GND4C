...
- a file containing the script for Export=>Templating... This one contains all four elements needed for the Export form. Do not copy the comments ("//") as they are visible in the exported .txt-file!
